        ...
        <template #header>
            <nav class="text-black font-bold" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li>
                        <a class="text-gray-500" aria-current="page">Editar</a>
                    </li>
                </ol>
            </nav>
                    ...
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            ...
                            <p class="mt-1 text-sm leading-5 text-gray-600">
                                Agregue la información relevante del vehículo a registrar incluyendo una imagen del mismo, tenga en cuenta que todos los campos son obligatorios.
                            </p>
                        </div>
                    </div>
    ...
    data() {
        return {
            vehiculo: {
                ...
                tipoCombustible: this.data.tipo_combustible,
                rendimientoEstipulado: this.data.rendimiento_estipulado,
                photo: this.data.photo_path
            },
            photoPreview: "/storage/"+this.data.photo_path,
        }
    },
    methods:{
